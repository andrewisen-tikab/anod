 ...
 */
export function renderGameLog(owner: any, state: GameState, logEl: HTMLElement) {
 ...
 */
export function renderGoldCounter(owner: any, state: GameState, el: HTMLElement) {
 ...
 */
export function renderChapterName(owner: any, state: GameState, el: HTMLElement) {
 ...
 */
export function registerClickCleanup(c: any, el: HTMLElement, handler: EventListener): void {
...
export function renderScene(
  ...
  return owner.effect((c: any) => {
    ...
    createTypewriter(owner, scene.text, narrativeEl, () => {
      /** After typewriter completes, show choices. */
    ...
    narrativeEl.addEventListener("click", skipHandler, { once: true });
    document.addEventListener("keydown", keyHandler, { once: true });

    c.cleanup(() => {
      narrativeEl.removeEventListener("click", skipHandler);
